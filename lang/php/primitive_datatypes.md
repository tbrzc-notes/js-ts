...
## compound
1. array: pueden contener diferentes datatypes, [deep_lecture](https://www.youtube.com/watch?v=C8ZFLq24g_A&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=11)
```php
...
## special
1. resource
2. null: si una variable ha sido declarada pero no ha sido asignada es null, `unset()` destruye la variable
```php
$typedvar = null
(int)$typedvar
```
